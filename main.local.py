...
def train_epoch(training_input, training_target, batch_size, mod = 'train'):
    ...
    return sum(epoch_training_losses)/len(epoch_training_losses), mae(labels, preds)
...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        ...
        loss, _ = train_epoch(training_input, 
                           training_target,
        ...
        # Run validation
        with torch.no_grad():  
            val_loss, val_metric = train_epoch(val_input,
                                   val_target,
                                   batch_size=batch_size,
                                   mod='eval')
        ...
        print("Validation MAE: {}".format(val_metric))
