...
from stgcn_pyg import STGCN
from tgcn_pyg import TGCN
...
class WrapperNet(pl.LightningModule):
    ...
    def __init__(self, hparams, edge_index, edge_weight):
    ...
    def forward(self, X):
        return self.net(X, self.edge_index, self.edge_weight)
...
if __name__ == '__main__':
    ...
    net = WrapperNet(hparams, edge_index, edge_weight)
